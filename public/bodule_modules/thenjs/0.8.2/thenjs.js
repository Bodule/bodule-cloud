define('thenjs@0.8.2/then', [], function (require, exports, module) {
  ...
  "use strict";
     ...
     */
    (function() {
        var slice = [].slice, isArray = Array.isArray, nextTick = typeof process === "object" && isFunction(process.nextTick) ? process.nextTick : setTimeout;
        function isNull(obj) {
        ...
        function thenjs(startFn, context) {
            var fail = [], Promise = function() {}, prototype = Promise.prototype;
            function promiseFactory(fn, context) {
                var promise = new Promise(), defer = promise.defer.bind(promise);
...
define('thenjs@0.8.2/thenjs', ['thenjs@0.8.2/then.js'], function (require, exports, module) {module.exports = require('thenjs@0.8.2/then.js');})