define('knockout@2.3.0/build/output/knockout-latest.debug', [], function (require, exports, module) {
        ...
        (function(undefined) {
            ...
            (function(factory) {
                ...
                ko.utils = function() {
                    ...
                    return {
                        ...
                        arrayFirst: function(array, predicate, predicateOwner) {
                            for (var i = 0, j = array.length; i < j; i++) if (predicate.call(predicateOwner, array[i])) return array[i];
                            return null;
                        },
                        ...
                        arrayFilter: function(array, predicate) {
                            array = array || [];
                            var result = [];
                            for (var i = 0, j = array.length; i < j; i++) if (predicate(array[i])) result.push(array[i]);
                            return result;
                        },
                ...
                ko.dependentObservable = function(evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
                    ...
                    function evaluateImmediate() {
                        ...
                        try {
                            ...
                            ko.dependencyDetection.begin(function(subscribable) {
                                var inOld;
                                if ((inOld = ko.utils.arrayIndexOf(disposalCandidates, subscribable)) >= 0) disposalCandidates[inOld] = undefined; else addSubscriptionToDependency(subscribable);
                            });
                    ...
                    var writeFunction = options["write"], disposeWhenNodeIsRemoved = options["disposeWhenNodeIsRemoved"] || options.disposeWhenNodeIsRemoved || null, disposeWhen = options["disposeWhen"] || options.disposeWhen || function() {
                        return false;
                    ...
                    return {
                        ...
                        parseObjectLiteral: function(objectLiteralString) {
                            ...
                            for (var position = 0; position < str.length; position++) {
                                ...
                                if (c === tokenStartChar) tokenDepth++; else if (c === tokenEndChar) {
                                    tokenDepth--;
                                    if (tokenDepth === 0) {
                                        var token = str.substring(tokenStart, position + 1);
                                        tokens.push(token);
                        ...
                        keyValueArrayContainsKey: function(keyValueArray, key) {
                            for (var i = 0; i < keyValueArray.length; i++) if (ko.utils.stringTrim(keyValueArray[i]["key"]) == key) return true;
                            return false;
                        },
                        ...
                        if (childNode) {
                            do {
                                ...
                                captureRemaining.push(childNode); else if (isStartComment(childNode)) {
                                    ...
                                    childNode = matchingEndComment; else captureRemaining = [ childNode ];
                ...
                (function() {
                    ...
                    function createBindingsStringEvaluator(bindingsString) {
                        ...
                        var rewrittenBindings = ko.expressionRewriting.preProcessBindings(bindingsString), functionBody = "with($context){with($data||{}){return{" + rewrittenBindings + "}}}";
                ...
                function makeWithIfBinding(bindingKey, isWith, isNot, makeContextCallback) {
                    ko.bindingHandlers[bindingKey] = {
                        ...
                        update: function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                            var withIfData = ko.utils.domData.get(element, withIfDomDataKey), dataValue = ko.utils.unwrapObservable(valueAccessor()), shouldDisplay = !isNot !== !dataValue, // equivalent to isNot ? !dataValue : !!dataValue
                    ...
                    ko.bindingHandlers["template"] = {
                        init: function(element, valueAccessor) {
                            ...
                            if (typeof bindingValue != "string" && !bindingValue["name"] && (element.nodeType == 1 || element.nodeType == 8)) {
                                ...
                                var templateNodes = element.nodeType == 1 ? element.childNodes : ko.virtualElements.childNodes(element), container = ko.utils.moveCleanedNodesToContainerElement(templateNodes);
                        ...
                        update: function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                            var templateName = ko.utils.unwrapObservable(valueAccessor()), options = {}, shouldDisplay = true, dataValue, templateComputed = null;
                    ...
                    function compareSmallArrayToBigArray(smlArray, bigArray, statusNotInSml, statusNotInBig, dontLimitMoves) {
                        ...
                        for (smlIndex = 0; smlIndex <= smlIndexMax; smlIndex++) {
                            ...
                            for (bigIndex = bigIndexMinForRow; bigIndex <= bigIndexMaxForRow; bigIndex++) {
                                ...
                                thisRow[bigIndex] = bigIndex + 1; else if (smlArray[smlIndex - 1] === bigArray[bigIndex - 1]) thisRow[bigIndex] = lastRow[bigIndex - 1]; else {
                        ...
                        if (notInSml.length && notInBig.length) {
                            ...
                            var limitFailedCompares = smlIndexMax * 10, failedCompares, a, d, notInSmlItem, notInBigItem;
...
define('knockout@2.3.0/knockout', ['knockout@2.3.0/build/output/knockout-latest.debug.js'], function (require, exports, module) {module.exports = require('knockout@2.3.0/build/output/knockout-latest.debug.js');})